...
public class DeviceAddress implements Cloneable {
    ...
    private static Map<String, DeviceAddress> instanceStore = new HashMap<>();
    ...
    //    用系统参数创建一个对象并返回
    private void initBySSALConfigProperties(String administrativeOrLogicalAddressHex) {
        this.setLogicalAddress(true);
        this.setAdministrativeOrLogicalAddress(administrativeOrLogicalAddressHex);
    ...
    public static DeviceAddress giveMeOne(String administrativeOrLogicalAddressHex) {
        DeviceAddress deviceAddress = instanceStore.get(administrativeOrLogicalAddressHex);
        if (deviceAddress == null) {
            deviceAddress = new DeviceAddress();
            deviceAddress.initBySSALConfigProperties(administrativeOrLogicalAddressHex);
            instanceStore.put(administrativeOrLogicalAddressHex, deviceAddress);
        }
        return deviceAddress.copy();
    }
